  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-24 text-center">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
        ...
        <Link
          href="/"
          className="rounded-sm border border-border-default bg-bg-elevated px-4 py-2 font-sans text-sm font-semibold text-text-tertiary transition-colors hover:border-border-strong hover:text-text-secondary"
        >
