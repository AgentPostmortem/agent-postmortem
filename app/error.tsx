...
export default function GlobalError({
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-24 text-center">
      <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-sm border border-border-strong bg-bg-surface">
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
        ...
        <Link
          href="/"
          className="rounded-sm border border-border-default bg-bg-elevated px-4 py-2 font-mono text-[11px] uppercase tracking-wider text-text-tertiary transition-colors hover:border-border-strong hover:text-text-secondary"
        >
