...
export const metadata: Metadata = {
  ...
  description: "Submit an AI agent failure case to the public registry. Anonymous submissions accepted.",
};
    ...
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
      ...
      <div className="mb-8">
        <div className="mb-3 flex items-center gap-3">
          ...
          <span className="font-mono text-[10px] text-text-tertiary">REF: APM-PENDING</span>
        </div>
        <h1 className="font-serif text-3xl font-normal text-text-primary sm:text-4xl">
          File a Case Report
        </h1>
        <p className="mt-3 text-sm leading-relaxed text-text-secondary">
          Document what went wrong. Anonymous submissions accepted. PII in screenshots
          is automatically redacted. If you provide an email, you&apos;ll receive a
          private one-time edit token.
        </p>
      </div>
        ...
        <ul className="divide-y divide-border-default">
          {[
            ...
            <li key={item} className="flex items-start gap-3 px-4 py-2.5">
              <span className="mt-0.5 font-mono text-[10px] text-accent-red">→</span>
