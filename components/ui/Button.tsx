  ...
  function Button(
    ...
    return (
      <button
        ...
        className={cn(
          "inline-flex items-center justify-center gap-2 rounded-sm font-mono text-xs uppercase tracking-widest transition-colors disabled:cursor-not-allowed disabled:opacity-50",
